...
namespace ArchiveCacheManager
{
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button3);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, icon, MessageBoxDefaultButton.Button3);
        }
        ...
        /// <param name="icon">The icon.</param>
        /// <returns></returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, Bitmap icon)
        {
            return FlexibleMessageBoxForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button3, icon);
        }
        ...
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, icon, MessageBoxDefaultButton.Button3);
        }
        ...
        /// <param name="icon">The icon.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, Bitmap icon)
        {
            return FlexibleMessageBoxForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button3, icon);
        }
        ...
        /// <param name="defaultButton">The default button.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, Bitmap icon, MessageBoxDefaultButton defaultButton)
        {
        ...
        public class FlexibleMessageBoxForm : Form
        {
            ...
            private static void SetDialogIcon(FlexibleMessageBoxForm flexibleMessageBoxForm, MessageBoxIcon icon, Bitmap bitmapIcon)
            {
                if (bitmapIcon != null)
                {
                    flexibleMessageBoxForm.pictureBoxForIcon.Image = bitmapIcon;
                }
                else
                {
                    switch (icon)
            ...
            private void FlexibleMessageBoxForm_Shown(object sender, EventArgs e)
            {
                ...
                {
                    case 3:
                        buttonToFocus = this.button3; break;
                    case 2:
                        buttonToFocus = this.button2; break;
                    case 1:
                    default:
                        buttonToFocus = this.button1; break;
                }
            ...
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, Bitmap bitmapIcon = null, string button1Text = null, string button2Text = null, string button3Text = null)
            {
                ...
                UserInterface.ApplyTheme(flexibleMessageBoxForm);
